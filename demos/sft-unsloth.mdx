...
| `standardize_data_formats` + `get_chat_template` + `formatting_prompts_func` | Automatic. Veri converts ShareGPT rows to chat `messages` and the trainer applies the model's chat template. |
