...
Veri bundles the reward, connects GSM8K, submits the job, and streams status to completion. Open the dashboard URL it prints to watch the live reward curve.

## Get the checkpoint

```bash
veri jobs download <job-id> --output ./checkpoints
```
