...
**Errors:**
- `402 Payment Required` — credit balance too low for the requested resources (see [Billing](/account/billing))
...
Supported `gpu_type` values: `A100-80GB`, `H100-80GB`, `L4-24GB`, `A10G-24GB`. (H200 and MI300X are roadmap.) On AWS, `A100-80GB` and `H100-80GB` launch as 8-GPU nodes; `L4-24GB` and `A10G-24GB` are the single-GPU shapes.
