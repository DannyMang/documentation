...
<Warning>
  MI300X capacity is coming soon and is not currently orderable: submits with
  `provider: "hotaisle"` are rejected while we finish provider validation. This
  page documents the stack for when it opens up.
</Warning>
