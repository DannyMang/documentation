...
| `use_liger` | `false` | Opt-in [liger-kernel](https://github.com/linkedin/Liger-Kernel) fused training kernels. Works on AMD (ROCm) and NVIDIA; requires the package on the worker image (preinstalled on AMD providers). |
