...
- **A standard benchmark** — GSM8K, MMLU, IFEval, and any other lm-eval-harness task. [Benchmarks](/evaluations/benchmarks) run on the community-standard harness with their own data, prompting, and scoring; you only pick a model, and scores are comparable with published numbers.
