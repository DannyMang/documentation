...
Create an API key from the [Veri dashboard](https://www.veri.studio/settings/api-keys), then:
...
<CardGroup cols={3}>
  ...
  <Card title="Follow a guided demo" icon="route" href="/demos/managed-grpo-quickstart">
    Step-by-step walkthroughs from first run to live endpoint
  </Card>
</CardGroup>
