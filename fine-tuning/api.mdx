...
- `gpu.gpu_type` must be one of: `A100-40GB`, `A100-80GB`, `H100`, `H200`
...
```json
{
  ...
  "hyperparameters": {...},
  "output_name": "qwen-7b-math",
  "gpu_requested": {"type": "H100", "count": 2},
  "gpu": null,
  "provider": null,
  "error": null,
  "dashboard_url": null,
...
H100 GPUs only. Requires `environments` (an OpenReward env config) instead of `reward_function_id`.
...
Supported `gpu_type` values: `A100-40GB`, `A100-80GB`, `H100`, `H200`. (MI300X is roadmap.)
