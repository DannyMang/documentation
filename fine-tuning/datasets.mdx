...
keywords: ["datasets", "jsonl", "huggingface", "volumes", "fine-tuning data"]
---
...
For private HF datasets, set the Hugging Face token via your integrations settings; the token is encrypted at rest and applied automatically.
...
<CardGroup cols={2}>
  ...
  <Card title="Submit a training job" icon="brain" href="/api-reference/training-jobs">
