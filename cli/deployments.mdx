...
Returns aggregate counters: `total_requests`, `total_prompt_tokens`, `total_completion_tokens`, `total_cost_usd`, `avg_latency_ms`, `error_rate`, `uptime_seconds`. JSON output is dict-shaped (suitable for `jq`):
