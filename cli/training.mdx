...
Reward functions can't be deleted through the API yet (delete is on the roadmap) — uploading a corrected file as a new reward function is the current workflow.
