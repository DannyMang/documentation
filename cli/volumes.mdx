...
The `veri volumes` group manages persistent named storage that mounts into training workers at `/mnt/<volume-name>`. Conceptual overview lives in the [Volumes](/concepts/volumes) guide.
...
<CardGroup cols={2}>
  <Card title="Volumes overview" icon="hard-drive" href="/concepts/volumes">
