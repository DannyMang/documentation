...
description: "Serve any open-source model — base or trained — on a per-hour GPU with an OpenAI-compatible API."
...
The smallest viable example is in the [Quickstart](/deployments). This page is the mental model and the surface map.
...
<CardGroup cols={2}>
  <Card title="Quickstart: deploy a model" icon="rocket" href="/deployments">
