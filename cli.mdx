...
| `veri models` | [Model versions](/deployments/model-versions) | Save, register, versions, promote, rollback, pin, gate, retention |
| `veri evals` | [Evals](/evals) | Run prompt suites against deployments and model versions |
| `veri settings` | [Reference](/cli/reference) | Workspace settings: `retention` |
