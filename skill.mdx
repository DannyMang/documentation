...
Every command and constraint below is verified against the live API and `veri-sdk` 0.2.31 (the latest release). When docs and this file disagree, trust `veri <cmd> --help` and [the docs](https://docs.veri.studio).
