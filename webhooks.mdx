...
| `experiment.completed` | An [experiment](/evals/experiments) completes, with its verdict and per-evaluator aggregates. |
| `annotation.completed` | A reviewer completes an item in an [annotation queue](/evals/human-review). |
