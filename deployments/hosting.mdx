...
| `digitalocean` | `L40S-48GB` | 48 GB | 1 | Coming soon |
| `digitalocean` | `MI300X-192GB` | 192 GB | 1 | Coming soon |
| `hotaisle` | `MI300X-192GB` | 192 GB | 1 | Coming soon |

<Tip>
  The AMD MI300X carries 192 GB of VRAM on a single GPU — enough to serve a 70B model in bf16 on one card, where NVIDIA equivalents need a multi-GPU node.
</Tip>
