...
description: "Recipes: deploy + chat + stop, serve a trained model, and swap models."
keywords: ["examples", "deploy", "chat", "train", "OpenAI SDK"]
---
...
Structured comparison with scoring will be covered by Evaluations, coming soon.
